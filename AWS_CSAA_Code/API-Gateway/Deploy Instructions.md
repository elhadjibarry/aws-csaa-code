    ...
    "Statement": [
        {
            ...
            "Principal": "*",
            "Action": "s3:GetObject",
            "Resource": "arn:aws:s3:::frontend-website-911/*"
        }
    ]
}
...
New integration is ready. Note integration ID: jdzybb8
...
Configure CORS. All 6 fields should be configured:
    The bucket URL (for N.Virgina buckets) should be: https://frontend-website-911.s3.amazonaws.com
...
* Invoke URL: https://gd84pecji3.execute-api.us-east-1.amazonaws.com/prod

* Integration ID: jdzybb8
...
For example, if invoke URL for API is "https://gd84pecji3.execute-api.us-east-1.amazonaws.com/prod" then apiId is first part after "https://" i.e. 0zf6cghiv8
